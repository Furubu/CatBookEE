<nav class="navbar navbar-inverse">
    <ul class="nav navbar-nav">
        <li role="presentation" <% if(request.getParameter("active").equals("Purrfile")) out.print("class=\"active\""); %>><a href="./Purrfile">Purrfile</a></li>
        ...
        <li role="presentation" <% if(request.getParameter("active").equals("Groups")) out.print("class=\"active\""); %>><a href="./Groups">Grupos</a></li>       
    </ul>
