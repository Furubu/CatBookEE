...
<html>
    ...
    <body>
        ...
        <%
            ...
            Collection<Postcb> posts = null;
            try {
                posts = (Collection<Postcb>) request.getAttribute("posts");
            } catch (Exception e) {
        ...
        <section>
            <center>
                <form name="newPost" action="NewPostServlet" method="post">
                    ...
                    <textarea name="post" value="" class="form-control" style="width:400px; height: 150px"></textarea>
                    <button type = "submit" class="btn" style="margin-right: 10px; margin-top: 15px"> Post! </button>
