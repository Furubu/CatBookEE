 ...
 * @author Xato
 */
@WebServlet(name = "CatLogin", urlPatterns = {"/CatLogin"})
public class CatLoginServlet extends HttpServlet {
    
    @EJB
    private UsercbFacade catUser;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Usercb user = this.catUser.find(this.catUser.getUserIdByEmail(request.getParameter("email")));
